---
description: Writes and runs tests for a specific OS_Instructor feature. Pass the spec name as argument e.g. /test-feature mode-A
...
<spec-name> e.g. /test-feature mode-A"
...
Invoke the **os-instructor-test-writer** subagent with the
following context:
...
Wait for os-instructor-test-writer to fully complete and
...
Once os-instructor-test-writer has finished, invoke the
**os-instructor-test-runner** subagent with the following
context:
...
- If os-instructor-test-writer reports it could not write
...
**Step 2 — Test Results**
- Mirror the os-instructor-test-runner's structured report
